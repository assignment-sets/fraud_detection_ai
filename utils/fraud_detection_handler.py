...
if __name__ == '__main__':
    ...
    news = handler.fetch_real_time_news("Kanye West Oscars")
    end_time = time.time()

    for key, article in news.items():
        print(f"{key}: {article['title']} - {article['publishedAt']}")
